...
import com.honeywell.usbakerydex.versatile.utils.VersatileResponseAdjustmentType
import com.honeywell.usbakerydex.versatile.utils.VersatileResponseCode
import com.honeywell.usbakerydex.versatile.utils.VersatileResponseParams
...
data class VersatileDexResponse(val lines: Array<VersatileDexResponseEntry>) {
    ...
    fun invoiceAdjustments(invoiceNumber: String): List<VersatileDexResponseEntry>? {
        return invoice(invoiceNumber)?.filter { it.adjustmentType in VersatileResponseAdjustmentType.invoiceAdjustmentTypes() }
    }
}
