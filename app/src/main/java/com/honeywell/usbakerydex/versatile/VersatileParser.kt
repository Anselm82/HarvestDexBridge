package com.honeywell.usbakerydex.versatile

import com.honeywell.usbakerydex.versatile.model.VersatileDexResponse
import com.honeywell.usbakerydex.versatile.model.VersatileDexResponseEntry
    ...
    companion object {
        ...
        private fun toVersatileResponseParamsMap(
            ...
            when (adjustmentType) {
                ...
                VersatileResponseAdjustmentType.ADJ_INVC_KILL_PREVIOUS_ALLOW_CHG -> params.clear()
            }
            return params
        }
