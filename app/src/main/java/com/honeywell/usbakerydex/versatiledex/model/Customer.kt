...
data class Customer(
    ...
    private fun validCommId() =
        !commId.isNullOrBlank() && commId!!.validLength(10) && commId!!.isNumeric()

    private fun validNumber() =
        !number.isNullOrBlank() && number!!.validLength(10) && number!!.isNumeric()

    private fun validName() =
        !number.isNullOrBlank() && name!!.validLength(30) && name!!.isAlphanumeric()

    private fun validAddress() =
        !address.isNullOrBlank() && address!!.validLength(30) && address!!.isAlphanumeric()

    private fun validCity() =
        !city.isNullOrBlank() && city!!.validLength(20) && city!!.isAlphanumeric()

    private fun validState() =
        !state.isNullOrBlank() && state!!.validLength(2) && state!!.isAlphanumeric()

    private fun validZip() = !zip.isNullOrBlank() && zip!!.validLength(2) && zip!!.isAlphanumeric()
    private fun validPhone1() =
        !phone1.isNullOrBlank() && phone1!!.validLength(16) && phone1!!.isAlphanumeric()

    private fun validPhone2() =
        !phone2.isNullOrBlank() && phone2!!.validLength(16) && phone2!!.isAlphanumeric()

    private fun validContact() =
        !contact.isNullOrBlank() && contact!!.validLength(30) && contact!!.isAlphanumeric()
