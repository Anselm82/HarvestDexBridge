...
data class G82(
    ...
    fun putString(key: String, value: String?) {
        when(key) {
            "01" -> this.creditDebitFlagCode =  if(value.isNullOrBlank() || value !in CreditDebitFlagCode.values()) null else value
            ...
            "11" -> this.shipmentMethodOfPayment = if(value.isNullOrBlank() || value !in ShipmentMethodOfPayment.values()) null else value
