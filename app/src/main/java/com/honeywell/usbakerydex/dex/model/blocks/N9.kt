...
data class N9(
    ...
    fun putString(key: String, value: String?) {
        when(key) {
            "01" -> this.referenceIdentificationQualifier = if(value.isNullOrBlank() || value !in ReferenceIdentificationQualifier.values()) ReferenceIdentificationQualifier.SHIPPING_LABEL_SERIAL_NUMBER else value
